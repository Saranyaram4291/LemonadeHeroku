...
import com.att.lemonade.screen.page.objects.SVIDSAdminPage;
...
public class TC04_SVIDS_Admin {
	private Logger log = Logger.getLogger(TC04_SVIDS_Admin.class);
	...
	public void TC04_SVIDS_Admin_Flow(Hashtable<String,Hashtable<String,String>> testData) throws Exception {
		String testCaseUniqueKey = ExtentManager.getTestKey("TC04_SVIDS_Admin_Flow", testData);
		...
		try {
			...
			et.log(LogStatus.INFO,testCaseUniqueKey+"==>"+"Navigating to SVIDS admin Page"); 
			
			SVIDSAdminPage ap=new SVIDSAdminPage(driver,testCaseUniqueKey,0);
			ap.Search(td);
