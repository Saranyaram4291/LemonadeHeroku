...
public class TC05_My_SVIDS {
	private Logger log = Logger.getLogger(TC05_My_SVIDS.class);
	...
	public void TC05_My_SVIDS_Flow(Hashtable<String,Hashtable<String,String>> testData) throws Exception {
		String testCaseUniqueKey = ExtentManager.getTestKey("TC05_My_SVIDS_Flow", testData);
		...
		try {
			...
			MySvidsPage ap=new MySvidsPage(driver,testCaseUniqueKey,0);
			ap.Search(td);
