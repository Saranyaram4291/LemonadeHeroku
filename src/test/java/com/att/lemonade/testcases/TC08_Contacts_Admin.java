...
import com.att.lemonade.screen.page.objects.ContactsAdminPage;
import com.att.lemonade.screen.page.objects.LoginPage;
import com.att.lemonade.screen.page.objects.MyContactPage;
import com.att.lemonade.screen.page.objects.MySvidsPage;

import com.att.lemonade.screen.page.objects.MyTeamSvidsPage;
...
public class TC08_Contacts_Admin {
	private Logger log = Logger.getLogger(TC08_Contacts_Admin.class);
	...
	public void TC08_Contacts_Admin_Flow(Hashtable<String,Hashtable<String,String>> testData) throws Exception {
		
		String testCaseUniqueKey = ExtentManager.getTestKey("TC08_Contacts_Admin_Flow", testData);
	...
	try
	{
			...
			et.log(LogStatus.INFO,testCaseUniqueKey+"==>"+"Navigating to Contacts admin Page"); 
			
			ContactsAdminPage ap=new ContactsAdminPage(driver,testCaseUniqueKey,0);
			ap.Search(td);
		...
		log.info("End of My Team SVIDs Flow");
