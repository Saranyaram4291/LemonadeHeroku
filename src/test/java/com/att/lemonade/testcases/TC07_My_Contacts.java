...
public class TC07_My_Contacts {
	private Logger log = Logger.getLogger(TC07_My_Contacts.class);
	...
	public void TC07_My_Contacts_Flow(Hashtable<String,Hashtable<String,String>> testData) throws Exception {
		
		String testCaseUniqueKey = ExtentManager.getTestKey("TC07_My_Contacts_Flow", testData);
	...
	try
	{
			...
			et.log(LogStatus.INFO,testCaseUniqueKey+"==>"+"Navigating to My Contacts Page"); 
			
			MyContactPage ap=new MyContactPage(driver,testCaseUniqueKey,0);
			ap.Search(td);
