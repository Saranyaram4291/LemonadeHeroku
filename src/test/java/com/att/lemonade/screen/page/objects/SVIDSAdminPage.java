...
public class SVIDSAdminPage extends CommonFunctions{
	...
	public SVIDSAdminPage(WebDriver driver, String testCaseUniqueKey, int timeouts){
		this.driver = driver;
		...
		///html/body/div/my-app/app-account/div/div/div/div/div[2]/div[2]/div[2]/button
		//ATTUID search icon
		...
		@FindBy(xpath="//select[@field='naicsCode']")
		...
		static Logger logger = Logger.getLogger(SVIDSAdminPage.class.getName());
		...
		public void Search(TCData td) throws Exception{
			...
			String responseCapturedTime=null;
				...
				{
					if(e.getText().equalsIgnoreCase("SVIDs Admin"))
					{
						e.click();
						break;
					}
				...
				{
					attuid.sendKeys(td.getAttuid());
					attuid_Searchicon.click();
					CommonFunctions.pause(8);
				}
