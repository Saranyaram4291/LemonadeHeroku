...
public class MyContactPage extends CommonFunctions{
	...
	public MyContactPage(WebDriver driver, String testCaseUniqueKey, int timeouts){
		this.driver = driver;
		...
		public void Search(TCData td) throws Exception{
			...
			System.out.println("Inside MyContact Page");
		...
		//	CommonFunctions.waitUntillPageLoad(driver);
			...
			{
				if(e.getText().equalsIgnoreCase("My Contacts"))
				{
					e.click();
					break;
				}
